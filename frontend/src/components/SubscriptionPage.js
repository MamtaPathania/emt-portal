  ...
  return (
    <div className="bg-black">
      ...
      <form
        ...
        className="flex flex-col lg:flex-row justify-center items-center gap-8 mt-4"
      >
        <div className="lg:flex items-center flex justify-center">
          <label className="text-white text-xl">Select Service: </label>
          <select 
            name="service"
            value={values.service}
            onChange={(e) => handleChange('service', e.target.value)}
                 className="border p-1 m-5 w-[180px]"
          >
        ...
        <div className="lg:flex items-center mr-3 ml-3 lg:ml-0 lg:mr-0">
          ...
          <button
            type="submit" 
            className="mt-16 lg:mt-0  text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center lg:mr-2 ml-32 lg:ml-8 mb-2 "
          >
            Submit
          </button>
        </div>
...
{!submitClicked && infoData && infoData.length > 0?(
        <div className="mt-16 lg:mt-4 lg-32 flex justify-center  items-center">
