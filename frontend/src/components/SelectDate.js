...
const SelectDate = ({ handleDateChange }) => {
  ...
  return (
    <div className='relative lg:flex items-center flex justify-center'>
      <label className="text-white text-xl">Select Date Range: </label>
      ...
      <input
        ...
        className="border p-1 m-5 lg:w-[180px] w-[175px]"
