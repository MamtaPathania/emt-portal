...
function HomePage() {
  ...
  return (
    <div className='bg-black'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col lg:flex-row justify-center items-center  gap-8 mt-6'>
        <div className="lg:flex lg:flex-row lg:items-center">
          ...
          <input
            ...
            className='border lg:m-4 p-1 w-[170px] m-1'
          />
        </div>
        ...
        <div className="lg:flex items-center ">
          ...
          className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center lg:mr-2 ml-32 lg:ml-8 mb-2 md:mt-0 lg:mt-0 mt-6 ">
            Submit</button>
      ...
      {Array.isArray(tabledata) && tabledata.length > 0 ? (
        <div className="p-8 overflow-x-auto shadow-md sm:rounded-lg lg:mt-6">
